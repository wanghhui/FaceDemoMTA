...
public class Verify extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//findViewById(R.id.online_pick).setOnClickListener(Verify.this);
		//findViewById(R.id.online_reg).setOnClickListener(Verify.this);
		findViewById(R.id.online_verify).setOnClickListener(Verify.this);
		findViewById(R.id.online_camera).setOnClickListener(Verify.this);
		//findViewById(R.id.online_detect).setOnClickListener(Verify.this);
		//findViewById(R.id.online_align).setOnClickListener(Verify.this);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == REQUEST_PICTURE_CHOOSE) {
			...
			if(null != bmp){
				FaceUtil.saveBitmapToFile(Verify.this, bmp);
			}
			// 获取图片保存路径
			fileSrc = FaceUtil.getImagePath(Verify.this);
			// 获取图片的宽和高
