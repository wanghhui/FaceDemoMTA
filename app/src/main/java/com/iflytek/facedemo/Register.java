...
public class Register extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.online_pick).setOnClickListener(Register.this);
		findViewById(R.id.online_reg).setOnClickListener(Register.this);
		//findViewById(R.id.online_verify).setOnClickListener(Register.this);
		findViewById(R.id.online_camera).setOnClickListener(Register.this);
		//findViewById(R.id.online_detect).setOnClickListener(Register.this);
		//findViewById(R.id.online_align).setOnClickListener(Register.this);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == REQUEST_PICTURE_CHOOSE) {
			...
			if(null != bmp){
				FaceUtil.saveBitmapToFile(Register.this, bmp);
			}
			// 获取图片保存路径
			fileSrc = FaceUtil.getImagePath(Register.this);
			// 获取图片的宽和高
